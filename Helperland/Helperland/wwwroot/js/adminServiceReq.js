...
function updateServiceRequest() {
    ...
    if ($("#admin-sr-mdate").val() == null) {
        ...
        $("#editModalAlert").removeClass("d-none").text("House number can not be empty!");
        $("#modal-house").focus();
    }
    else if ($("#modal-street").val().trim() == "") {
        $("#editModalAlert").removeClass("d-none").text("Street can not be empty!");
        $("#modal-street").focus();
    }
    else if ($("#modal-postal").val().trim() == "") {
        $("#editModalAlert").removeClass("d-none").text("Postalcode can not be empty!");
        $("#modal-postal").focus();
    }
    else if ($("#modal-city").val().trim() == "") {
        $("#editModalAlert").removeClass("d-none").text("City can not be empty!");
        $("#modal-city").focus();
    }
